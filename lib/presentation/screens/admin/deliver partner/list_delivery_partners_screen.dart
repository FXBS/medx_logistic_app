...
class ListDeliveryPartnersScreen extends StatefulWidget {
  ...
  @override
  State<ListDeliveryPartnersScreen> createState() => _ListDeliveryPartnersScreenState();
}

class _ListDeliveryPartnersScreenState extends State<ListDeliveryPartnersScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<UserBloc, UserState>(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Colors.white,
          title: const TextCustom(text: 'List Delivery Partner'),
          centerTitle: true,
          leadingWidth: 80,
          leading: InkWell(
