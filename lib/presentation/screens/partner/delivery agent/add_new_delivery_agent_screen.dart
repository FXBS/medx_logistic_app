...
class AddNewDeliveryAgentScreen extends StatefulWidget {

  @override
  _AddNewDeliveryAgentScreenState createState() => _AddNewDeliveryAgentScreenState();
}


class _AddNewDeliveryAgentScreenState extends State<AddNewDeliveryAgentScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<UserBloc, UserState>(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Colors.white,
          title: const TextCustom(text: 'Add New Delivery Agent'),
          centerTitle: true,
          leadingWidth: 80,
          leading: TextButton(
