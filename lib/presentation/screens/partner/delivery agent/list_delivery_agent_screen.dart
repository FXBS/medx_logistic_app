...
import 'package:restaurant/presentation/screens/partner/delivery%20agent/add_new_delivery_agent_screen.dart';
import 'package:restaurant/presentation/themes/colors_frave.dart';

class ListDeliveryAgentsScreen extends StatefulWidget {

  @override
  State<ListDeliveryAgentsScreen> createState() => _ListDeliveryAgentsScreenState();
}

class _ListDeliveryAgentsScreenState extends State<ListDeliveryAgentsScreen> {
    ...
    return BlocListener<UserBloc, UserState>(
      listener: (context, state) {
        ...
        if(state is SuccessUserState ){
          ...
          modalSuccess(context, 'Delivery Agent Deleted', () {
            Navigator.pop(context);
            setState(() {});
          });
