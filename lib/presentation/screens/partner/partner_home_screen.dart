    ...
    return BlocListener<UserBloc, UserState>(
      listener: (context, state) {
        if (state is LoadingUserState) {
          ...
          modalSuccess(context, 'Picture Change Successfully', () => Navigator.pushReplacement(context, routeFrave(page: PartnerHomeScreen())));
          Navigator.pop(context);
        ...
        body: SafeArea(
          child: ListView(
            ...
            children: [
              ...
              const SizedBox(height: 15.0),
              const TextCustom(text: 'Med-X', color: Colors.grey),
              const SizedBox(height: 10.0),
              ItemAccount(
                text: 'Categories',
